...
return array(
	...
	'name'=>'Bugs',
	'defaultController' => 'errores/admin',
	...
	'modules'=>array(
		...
		'gii'=>array(
			...
			'cruge'=>array(
					...
					//
					'afterLoginUrl'=>array('/site/login'),
					...
					'editProfileLayout'=>/*'//layouts/column2',*/ 'ui',
	...
	'components'=>array(
		...
		'mascaraEntrada'=>array(
			'class'=>'application.components.MascaraEntrada'
		),
		'tiempo'=>array(
				'class'=>'application.components.Tiempo'
		),
		...
		*/
		'db'=>array(
			'connectionString' => 'pgsql:host=localhost;port=5432;dbname=bugger',
			'emulatePrepare' => true,
			'username' => 'postgres',
			'password' => '123456',
			'charset' => 'utf8',
